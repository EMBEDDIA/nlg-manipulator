import re
import logging
from dictionary_fi import MONTHS, SMALL_CARDINALS, SMALL_ORDINALS, CPHI, INCOME, HEALTH, COMPARISONS, COUNTRIES, TEMPLATES
...
class FinnishRealizer():
    ...
    def _time_month(self, random, slot):
        ...
        if (slot.attributes['name_type'] in ['full', 'short']) or (
            ...
            new_slot = LiteralSlot(MONTHS[month] + 'ssa')
