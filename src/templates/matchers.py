...
OPERATORS = {
    "=": equal_op, "!=": operator.ne, ">": operator.gt, "<": operator.lt, ">=": operator.ge, "<=": operator.le,
...
class ReferentialExpr(object):
    ...
    def __call__(self, message, all):
        return getattr(all[self.reference_idx], self.field_name)
