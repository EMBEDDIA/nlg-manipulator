...
from bottle import TEMPLATE_PATH, Bottle, redirect, request, response, run, static_file, view
...
def news_html():
    ...
    return dict({"where": where, "where_type": where_type, "language": language, "header": header, "body": body})
